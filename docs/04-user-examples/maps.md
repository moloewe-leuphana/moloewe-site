...
You can copy/paste the respective python code in your notebook and adjust it to your needs. For the python codes to work, you must import the following modules in your notebook first:
...
### Polygon **Choropleth Map - Continuous Color Scale**

### Example

Buildings colored according to their height. The source data is a shape file (imported to the MoLöWe-Server). Hovering over a building will show its index in the shape file and its height (”HOEHEGEB”). A continuous color scale is used.
...
### Polygon **Choropleth Map - Discrete Color Scale**
...
### Polygon **Choropleth Map - Discrete Color Scale, Slider and Barchart**
